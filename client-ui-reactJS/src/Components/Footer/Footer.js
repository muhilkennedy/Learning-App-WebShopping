            ...
            <div className="footer">
                <div className="container">
                    ...
                    <div className="footer-bottom">
                        ...
                        <p className="fo-para">This is Owner name and Shop Details</p>
                        ...
                        <div className=" address">
                            <div className="col-md-4 fo-grid1">
                                <p><i className="fa fa-home" aria-hidden="true" />Tamil Nadu , Chennai, India.</p>
                            </div>
                            <div className="col-md-4 fo-grid1">
                                <p><i className="fa fa-phone" aria-hidden="true" />+91 xxxxxxxxxx</p>
                            </div>
                            <div className="col-md-4 fo-grid1">
                                <p><Link to="/gmail.com"><i className="fa fa-envelope-o" aria-hidden="true" />test@gmail.com</Link></p>
                            </div>
                            <div className="clearfix" />
                        </div>
                    </div>
                    <div className="copy-right">
                        <p> © 2020 Big store. All Rights Reserved </p>
                    </div>
                </div>
            </div>
