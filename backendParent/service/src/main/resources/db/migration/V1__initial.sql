...
CREATE TABLE IF NOT EXISTS TASK (TENANTID varchar(50) NOT NULL, EMPLOYEEID int NOT NULL, TASKID int NOT NULL AUTO_INCREMENT PRIMARY KEY, CONTENT varchar(1000), STATUS varchar(20), ASSIGNEE int NOT NULL, CONSTRAINT FOREIGN KEY(TENANTID) REFERENCES TENANT(TENANTID), CONSTRAINT FOREIGN KEY(EMPLOYEEID) REFERENCES EMPLOYEEINFO(EMPLOYEEID), CONSTRAINT FOREIGN KEY(ASSIGNEE) REFERENCES EMPLOYEEINFO(EMPLOYEEID));
