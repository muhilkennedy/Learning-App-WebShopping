...
CREATE TABLE IF NOT EXISTS TENANTDETAILS (TENANTID varchar(50) NOT NULL UNIQUE, TENANTDETAILID int NOT NULL AUTO_INCREMENT PRIMARY KEY, TENANTCONTACT varchar(10), TENANTEMAIL varchar(75), TENANTSTREET varchar(100), TENANTCITY varchar(50), TENANTPIN varchar(10), TENANTLOGO MEDIUMBLOB, TENANTFACEBOOK varchar(100), TENANTTWITTER varchar(100), TENANTINSTA varchar(100), CONSTRAINT FOREIGN KEY(TENANTID) REFERENCES TENANT(TENANTID));
...
insert into tenantdetails (tenantid, tenantdetailid, tenantcontact, tenantemail, tenantstreet, tenantcity, tenantpin, tenantfacebook, tenanttwitter, tenantinsta) values ('devTenant', 1, '1234567890', 'do.not.reply.ordering.application@gmail.com', '13, B block, Nelson Road', 'Chennai', '600028', 'https://www.facebook.com/', 'https://twitter.com/', 'https://www.instagram.com/');
