...
CREATE TABLE IF NOT EXISTS product (tenantid varchar(50) NOT NULL, categoryid double, productid double NOT NULL AUTO_INCREMENT PRIMARY KEY, productname varchar(50) NOT NULL, brand varchar(50) NOT NULL, cost DECIMAL(12,2) NOT NULL, offer DECIMAL(4,2) DEFAULT 0, description varchar(300) NOT NULL, productcode varchar(50) UNIQUE, unitsinstock int DEFAULT 0, lastmodified double, lastmodifiedemployeeid double, active BOOL DEFAULT TRUE, isdeleted BOOL DEFAULT FALSE, productrating int DEFAULT 0, sellingcost DECIMAL(12,2) NOT NULL, searchtext varchar(50), CONSTRAINT FOREIGN KEY(tenantid) REFERENCES tenant(tenantid), CONSTRAINT FOREIGN KEY(categoryid) REFERENCES category(categoryid), CONSTRAINT FOREIGN KEY(lastmodifiedemployeeid) REFERENCES employeeinfo(employeeid));
...
CREATE TABLE IF NOT EXISTS productreview (tenantid varchar(50) NOT NULL, productreviewid double NOT NULL AUTO_INCREMENT PRIMARY KEY, customerid double NOT NULL, productid double NOT NULL, rating int NOT NULL, review varchar(500) NOT NULL, reviewheader varchar(100) NOT NULL, usefullcount int, reviewtime double, CONSTRAINT FOREIGN KEY(productid) REFERENCES product(productid), CONSTRAINT FOREIGN KEY(tenantid) REFERENCES tenant(tenantid), CONSTRAINT FOREIGN KEY(customerid) REFERENCES customerinfo(customerid));
