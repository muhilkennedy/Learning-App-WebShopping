...
/* Customer tables */
CREATE TABLE IF NOT EXISTS customerinfo (tenantid varchar(50) NOT NULL, customerid int NOT NULL PRIMARY KEY, fname varchar(50) NOT NULL, lname varchar(50) NOT NULL, emailid varchar(100) NOT NULL UNIQUE, mobile varchar(1000), password varchar(100), active BOOL DEFAULT TRUE, lastlogin double, profilepic MEDIUMBLOB, loginvia varchar(25), profilePicUrl varchar(200), loyalitypoint DECIMAL(4,2), CONSTRAINT FOREIGN KEY(tenantid) REFERENCES tenant(tenantid));
