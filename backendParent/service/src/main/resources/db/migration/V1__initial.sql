...
/* Customer tables */
CREATE TABLE IF NOT EXISTS customer (tenantid varchar(50) NOT NULL, customerid int NOT NULL PRIMARY KEY, fname varchar(50) NOT NULL, lname varchar(50) NOT NULL, emailid varchar(100) NOT NULL UNIQUE, mobile varchar(1000) UNIQUE, password varchar(100), active BOOL DEFAULT TRUE, lastlogin double, profilepic MEDIUMBLOB, CONSTRAINT FOREIGN KEY(tenantid) REFERENCES tenant(tenantid));
CREATE TABLE IF NOT EXISTS customeraddress (tenantid varchar(50) NOT NULL, customerid int NOT NULL, addressid int NOT NULL AUTO_INCREMENT PRIMARY KEY, doornumber varchar(100) NOT NULL, street varchar(1000) NOT NULL, city varchar(75) NOT NULL, state varchar(75) NOT NULL, pincode varchar(20) NOT NULL, CONSTRAINT FOREIGN KEY(tenantid) REFERENCES tenant(tenantid), CONSTRAINT FOREIGN KEY(customerid) REFERENCES customer(customerid));
